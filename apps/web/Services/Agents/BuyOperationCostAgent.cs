...
{
    public BuyOperationCostAgent(FoundryOptions options, FoundryAgentProvisioner provisioner, ILogger<BuyOperationCostAgent> logger)
        : base(options, provisioner, logger, AgentInstructions.BuyOperations)
    {
    }
